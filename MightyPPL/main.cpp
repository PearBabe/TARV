...
//    }
    ...
    if (!out_format.has_value()) {
        ...
        if (out_fin) {
            ...
            if (initial_state.is_included_in(
                    monitaal::Fixpoint<monitaal::symbolic_state_t>::reach(
                            monitaal::Fixpoint<monitaal::symbolic_state_t>::accept_states(pos),
                            pos))) {
            ...
            if (initial_state.is_included_in(
                    monitaal::Fixpoint<monitaal::symbolic_state_t>::buchi_accept_fixpoint(pos))) {
        ...
        if (out_format.value()) {       // tck
            ...
            if (out_flatten) {
                ...
                for (auto i = 1; i < pos.number_of_clocks(); ++i) {
