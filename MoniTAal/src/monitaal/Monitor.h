...
namespace monitaal {
    ...
    public:
        ...
        [[nodiscard]] single_monitor_answer_e status() const;
    ...
    public:
        ...
        [[nodiscard]] single_monitor_answer_e positive_monitor_status() const;

        [[nodiscard]] single_monitor_answer_e negative_monitor_status() const;
